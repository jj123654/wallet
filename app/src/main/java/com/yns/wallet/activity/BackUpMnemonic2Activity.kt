...
import com.yns.wallet.databinding.ActivityBackUpMnemonic2Binding
import com.yns.wallet.util.showToast
import com.yns.wallet.widget.CommonCenterDialog
import kotlin.random.Random

class BackUpMnemonic2Activity : BaseActivity<ActivityBackUpMnemonic2Binding>() {
    ...
    override fun initView(root: View, savedInstanceState: Bundle?) {
        val menomics = intent?.getStringExtra("menomic")
        menomics?.let {
        ...
        viewBinding.apply {
            ...
            rvList.layoutManager = GridLayoutManager(this@BackUpMnemonic2Activity, 3)
            rvList.adapter = WordListAdapter(this@BackUpMnemonic2Activity, indexArray)
